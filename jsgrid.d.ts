...
interface JQuery<TElement extends Node = HTMLElement> {
    jsGrid(conf: Partial<JsGridConf>): void;
    ...
    jsGrid(cmd: "editItem", itemOrRow: string | Node | JQueryElement): void;
    jsGrid(cmd: "deleteItem", itemOrRow: string | Node | JQueryElement): Promise<any>;
    jsGrid(cmd: "insertItem" | "loadData" | "search", item: any): Promise<any>;
    jsGrid(cmd: "rowByItem", item: any): JQueryElement;
    jsGrid(cmd: "sort", confOrField: JsGridSortConfig | JsGridField, order?: "asc" | "desc"): Promise<any>;
    ...
    jsGrid(arg1: string, arg2: string | Node | JQueryElement | number | any): Promise<any> | void | Object;
}

interface jsGrid {
    locale(l: string | any): void;
    setDefaults(conf: Partial<JsGridConf>): void;
